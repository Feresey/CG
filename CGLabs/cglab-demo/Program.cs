...
public abstract class CGLab01 : GFXApplicationTemplate<CGLab01>
{
    ...
    {
        double sx = ShiftX + Offset.X; // С точки зрения производительности часто используемые свойства лучше 
        double sy = ShiftY + Offset.Y; // сохранить в локальные переменные или обращаться к связаным с ними полям
